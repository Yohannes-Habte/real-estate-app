...
const UpdateHouse = () => {
  ...
  // Get the id of the hotel using useparams hook
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `http://localhost:5000/api/houses/update/${hotelId}`,
        newData,
  ...
  //==============================================================================
  // Display the update house using useEffect hook
  //==============================================================================
  useEffect(() => {
    const getUpdatedHouse = async () => {
      try {
        const { data } = await axios.get(
          `http://localhost:5000/api/houses/house/${hotelId}`
        );
  ...
  return (
    <main className="houses-page">
      ...
      <section className="houses-container">
        <h1 className="houses-title">Update House Data</h1>
        ...
        <form onSubmit={handleSubmit} action="" className="form">
          ...
          <article className="house-image-details">
            ...
            <div className="image-wrapper">
              ...
              >
                {uploading ? <ButtonSpinner /> : 'Upload Images'}
              </button>
            </div>
            {imageUploadError && (
